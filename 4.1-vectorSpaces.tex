...
\\ They guarantee that vector addition and scalar multiplication "doesn't take us outside of a subspace". For showing U is nonempty it is enough to show that \(\mathbf{0} \in U\).
\newline
...
\newline
\tsIdea{E 4.13 (The nullspace is a subspace)}{Let \(A \in \mathbb{R}^{m \times n}\). Then the nullspace \(N(A) = \{\mathbf{x} \in \mathbb{R}^n : A\tsVec{x} = 0\}\) is a subspace of \(\mathbb{R}^n\)}
\newline
