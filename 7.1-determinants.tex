...
\begin{tcolorbox}[
    ...
    \begin{enumerate} [noitemsep, topsep=0pt]
        ...
        \item
              ...
              \(
              \Longrightarrow \det(Q)=1 \text{ or } \det(Q)=-1.
              \)
        \item
...
\newline
\tsProp{7.3.2 (Cofactor determinant calculation)}{\textbf{Co-factor method (Pick the row with most zeros, $A_{ij}$ is the matrix without row i and column j)}:
    \\
